...
import { Box, Text, Flex, Button, Grid, Link } from "@chakra-ui/react";
...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <Box
        as="footer"
        className={`relative transition-all duration-500 border-t overflow-hidden ${isDarkMode
      ...
      >
        ...
        <Box className="relative section-container py-10 px-6 md:px-8">
                  ...
                  <Flex className="gap-2">
                    {socialLinks.map((social, i) => (
                      <Link
                        ...
                        title={social.name}
                        className={`w-9 h-9 rounded-lg flex items-center justify-center shadow-md transition-all duration-300 transform focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 ${isDarkMode
          ...
          <Box
            className={`mt-10 pt-6 border-t text-center ${isDarkMode ? "border-gray-700" : "border-gray-200"
              }`}
          >
            <Flex className="flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
              ...
              <Flex className="items-center space-x-4 text-xs">
                <Link
                  href="/terms-of-use"
                  className={`hover:underline transition-colors duration-200 ${isDarkMode
